...
int main()
{
    ...
    catch (const MyException& e) { std::cout << e.what() << std::endl << std::endl; }
    try {
    ...
    try {
        Equilateral_triangle e_triangle(30, 30, 35, 60, 60, 60);
    ...
    try {
        Square s_quadrangle(20, 20, 20, 20, 90, 98, 90, 90);
